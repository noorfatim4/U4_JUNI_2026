...
public class BoardPanel extends JPanel {
    ...
    public BoardPanel(Controller controller) {
        ...
        setBackground(Color.BLACK); //TESTFÄRG
        ...
        for (int r = 0; r < SIZE; r++) {
            for (int c = 0; c < SIZE; c++) {
                ...
                btn.setStatus(TileOwner.EMPTY); // plats för mysterium senare
                tiles[r][c] = btn;
                add(btn);
            }
        }
    ...
    public void updateBoard(TileOwner[][] status) {   // tar Game istället för Board
